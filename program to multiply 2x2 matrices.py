...
if order==2:
       ...
       a=int(input("enter element a11 of B: "))
       b=int(input("enter element a12 of B: "))
       c=int(input("enter element a13 of B: "))
       d=int(input("enter element a21 of B: "))
       e=int(input("enter element a22 of B: "))
       f=int(input("enter element a23 of B: "))
       g=int(input("enter element a31 of B: "))
       h=int(input("enter element a32 of B: "))
       i=int(input("enter element a33 of B: "))
